   ...
   ID   PROVIDER            MODULE                          FUNCTION NAME
-- @@stderr --
dtrace: failed to match :::profile: No probe matches description
dtrace: failed to match :::vmlinux: No probe matches description
dtrace: failed to match :::read: No probe matches description
dtrace: failed to match :::begin: No probe matches description
dtrace: failed to match ::vmlinux:read: No probe matches description
